...
class AugmentedCIFAR10Data(object):
    ...
    def __init__(self, raw_cifar10data, sess, model):
        ...
        self.train_data = AugmentedDataSubset(raw_cifar10data.train_data, sess,
                                             self.x_input_placeholder,
                                              self.augmented)
        """self.train_data1 = AugmentedDataSubset(raw_cifar10data.train_data1, sess,
                                             self.x_input_placeholder,
                                              self.augmented)
        self.train_data2 = AugmentedDataSubset(raw_cifar10data.train_data2, sess,
                                             self.x_input_placeholder,
                                              self.augmented)
        self.train_data3 = AugmentedDataSubset(raw_cifar10data.train_data3, sess,
                                             self.x_input_placeholder,
                                              self.augmented)"""
